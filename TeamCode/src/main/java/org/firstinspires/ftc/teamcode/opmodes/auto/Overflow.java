...
public class Overflow extends OpMode {
    ...
    // Positions
    public static double AFTER_TAPE_Y = 160;
    public static double OFFSET_FROM_TAPE_TO_WALL = 20;
    public static double INTAKE_SHIFT_X = 10;
    public static double HALFWAY_HEADING = 135;
    public static double INTAKE_HEADING = 90;
    public static double INTAKE_SHIFTED_HEADING = 112.5;
    ...
    public static int GO_TO_INTAKE_TIME = 1500;
    public static int SHIFTING_INTAKE_TIME = 1000;
    ...
    public void init() {
        ...
        if (Status.alliance == Constants.Game.ALLIANCE.BLUE) {
            ...
            robotContainer.pathPlanner.addSleepPose(SHOOT_TIME);
                ...
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + INTAKE_SHIFT_X, AFTER_TAPE_Y - OFFSET_FROM_TAPE_TO_WALL, AngleUnit.DEGREES,  INTAKE_SHIFTED_HEADING), GO_TO_INTAKE_TIME);
                ...
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + INTAKE_SHIFT_X, AFTER_TAPE_Y - OFFSET_FROM_TAPE_TO_WALL, AngleUnit.DEGREES,  INTAKE_HEADING), SHIFTING_INTAKE_TIME);
                ...
                robotContainer.pathPlanner.addActionPose(intake);
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + 2 * INTAKE_SHIFT_X, AFTER_TAPE_Y - OFFSET_FROM_TAPE_TO_WALL, AngleUnit.DEGREES,  HALFWAY_HEADING), GO_TO_INTAKE_TIME);
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + INTAKE_SHIFT_X, AFTER_TAPE_Y, AngleUnit.DEGREES,  INTAKE_HEADING), SHIFTING_INTAKE_TIME);
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + 2 * INTAKE_SHIFT_X, AFTER_TAPE_Y - OFFSET_FROM_TAPE_TO_WALL, AngleUnit.DEGREES,  INTAKE_HEADING), SHIFTING_INTAKE_TIME);
                robotContainer.pathPlanner.addActionPose(endOfIntake);
                robotContainer.pathPlanner.addPoseTimeout(new Pose2D(DistanceUnit.CM, Status.startingPose.getX(DistanceUnit.CM) + 10, Status.startingPose.getY(DistanceUnit.CM), AngleUnit.DEGREES,  HALFWAY_HEADING), GO_TO_START_TIME);
                robotContainer.pathPlanner.addActionPose(shoot);
                robotContainer.pathPlanner.addSleepPose(SHOOT_TIME);
