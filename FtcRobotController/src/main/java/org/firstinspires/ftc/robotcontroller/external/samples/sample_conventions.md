...
Sensor:    	This is a Sample OpMode that shows how to use a specific sensor.
            It is not intended to drive a functioning robotContainer, it is simply showing the minimal code
...
Concept:	This is a sample OpMode that illustrates performing a specific function or concept.
            ...
            locate based on their name.  These OpModes may not produce a drivable robotContainer.

Utility:    This sample type is provided as a useful tool, or aide, to perform some specific development task.
            It is not expected to be something you would include in your own robotContainer code.
...
Special programming methods, or robotContainer control techniques should be reserved for “Concept” Samples,
